...
using LanguageGuesserML.Model;

namespace LanguageGuesserML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"H:\Documents\VisualStudioProjects\LanguageTextFiles\languages.TSV";
        private static string MODEL_FILEPATH = @"C:\Users\patrick.jilek-rodri\AppData\Local\Temp\MLVSTools\LanguageGuesserML\LanguageGuesserML.Model\MLModel.zip";
